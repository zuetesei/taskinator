...
// array to hold tasks we will save 
var tasks = [];
...
var taskFormHandler = function (event) {
    ...
    // checking if task is new one currently being edited by checking data-task-id 
...
var editTask = function (taskId) {
    ...
    // write values of taskname and task type to be edited 
    document.querySelector("input[name='task-name']").value = taskName;
    document.querySelector("select[name='task-type']").value = taskType;
   
    // set data attribute to form with a value of the task's id 
